...
<body>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="form-inline" action="UserManageaction?method=showUser" method="post">
                        ...
                        <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#userAddDialog" >添加用户</a>
                    </form>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
					...
					<div id="page" align="center">
						<ul class="list-pager">
							<li><a class="page_2"
								href="UserManageaction?method=showUser&userName=${sessionScope.userName}&page=${sessionScope.prepage}">上一页</a>
							</li>
							...
							<c:forEach var="u" items="${sessionScope.pagelist }">
								<li><a class="page_2"
									href="UserManageaction?method=showUser&userName=${sessionScope.userName}&page=${u}">${u}</a></li>
							</c:forEach>
							<li class="sep">...</li>
							<c:if test="${sessionScope.page ==100}">
								<li class="active"><a class="page_1" href="javascript:void(0);"
							...
							<c:if test="${sessionScope.page !=100}">
								<li><a class="page_27731"
									href="UserManageaction?method=showUser&userName=${sessionScope.userName}&page=100">100</a>
								</li>
							</c:if>
							<li><a class="page_2"
								href="UserManageaction?method=showUser&userName=${sessionScope.userName}&page=${sessionScope.lastpage}">下一页</a>
							</li>
						</ul>
					</div>
                </div>
	...
	<script type="text/javascript">
        ...
        var ADDUSER = {
            ...
            addUs:function() {
                $.post("UserManageaction",$("#add_user_form").serialize(),function(data){
                    alert("用户信息添加成功！");
        ...
        function deleteUser(id) {
            if(confirm('确实要删除该用户吗?')) {
                $.post("UserManageaction?method=deleteUser",{"id":id},function(data){
                    alert("用户删除成功！");
                    $("#chaxun").click();
                });
            }
