...
public class Movie {
	...
	public Movie(int movieid,String moviename, String showyear, String director, String leadactors,
			String picture, double averating, int numrating, String description, String typelist) {
		super();
		this.movieid=movieid;
		this.moviename = moviename;
		this.showyear = showyear;
	...
	public Movie(String moviename, String showyear, String director, String leadactors,
			String picture, double averating, int numrating, String description, String typelist) {
		super();
		this.moviename = moviename;
		this.showyear = showyear;
